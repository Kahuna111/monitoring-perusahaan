...
$pageTitle  = 'Uang Keluar (Pengeluaran)';
$activePage = 'pengeluaran';
$breadcrumb = 'Keuangan / Uang Keluar';
...
// Ambil kategori pengeluaran untuk filter dropdown
...
<div class="page-header">
    <div class="page-header-left">
        <h2>Uang Keluar (Pengeluaran)</h2>
        <p>Catat dan pantau seluruh pengeluaran kas perusahaan</p>
    </div>
    <a href="<?= BASE_URL ?>/admin/pengeluaran/tambah.php" class="btn btn-danger" id="btnTambahPengeluaran">
    ...
    <div class="card-body" style="padding:16px 24px;">
        <form method="GET" style="display:flex;gap:12px;flex-wrap:wrap;align-items:flex-end;">
            ...
            <?php if (isset($_GET['kategori_id']) || isset($_GET['tanggal_mulai'])): ?>
                <a href="<?= BASE_URL ?>/admin/pengeluaran/index.php" class="btn btn-outline" style="height:42px;display:inline-flex;align-items:center;">Reset</a>
            <?php endif; ?>
        </form>
    </div>
</div>
...
<div class="stats-grid mb-24" style="grid-template-columns: 1fr;">
    <div class="stat-card red" style="max-width:350px;">
        <div class="stat-icon red">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 19V5M19 12l-7 7-7-7"/></svg>
        </div>
        <div class="stat-info">
            <div class="stat-label">Total Pengeluaran Periode Ini</div>
            <div class="stat-value" style="font-size:22px;"><?= formatRupiah($totalPengeluaran) ?></div>
...
<div class="card">
    <div class="card-header">
        ...
        <span style="font-size:13px;color:#64748b;"><?= count($pengeluaranList) ?> transaksi ditemukan</span>
    </div>
    <div class="table-responsive">
        <table class="table data-table" id="tablePengeluaran">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-danger" style="font-size:11.5px;font-weight:600;">
                    ...
                    <td class="text-right fw-semibold" style="color:#ef4444;font-size:14px;">
                        -<?= formatRupiah($row['jumlah']) ?>
                    </td>
                    <td>
                        <div style="display:flex;gap:6px;">
                            <a href="<?= BASE_URL ?>/admin/pengeluaran/hapus.php?id=<?= $row['id'] ?>"
                               class="btn btn-danger btn-sm btn-icon"
                               title="Hapus"
                               data-confirm="Yakin ingin menghapus transaksi pengeluaran ini? Tindakan ini tidak dapat dibatalkan.">
